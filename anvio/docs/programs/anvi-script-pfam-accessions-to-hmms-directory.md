...
{{ codestart }}
anvi-script-pfam-accessions-to-hmms-directory --pfam-accessions-list ACC1 ACC2 -O output
{{ codestop }}

Or a file containing this list using `--pfam-accessions-file`. The file should have one accession number per line:

{{ codestart }}
anvi-script-pfam-accessions-to-hmms-directory --pfam-accessions-file file.txt -O output
{{ codestop }}
